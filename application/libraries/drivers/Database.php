...
abstract class Database_Driver {
	...
	static $sql_types = array(
		...
		// TIME
		'time'				=> array('type' => 'date', 'process_as' => 'date', 'format' => 'time'),
		'date'				=> array('type' => 'date', 'process_as' => 'date', 'format' => 'date'),
		'year'				=> array('type' => 'date', 'process_as' => 'date', 'format' => 'year'),
		'datetime'			=> array('type' => 'date', 'process_as' => 'date', 'format' => 'datetime'),
		'timestamp'			=> array('type' => 'date', 'process_as' => 'date', 'format' => 'datetime'),
		...
		// ENUM
		'enum'				=> array('type' => 'string', 'process_as' => 'enum'),
		'set'				=> array('type' => 'string', 'process_as' => 'set'),
	 ...
	 * @return  array
	 */
	abstract public function list_tables(DatabaseLibrary $db);
	...
	protected function sql_type($str)
	{
		...
		switch ($field['type'])
		{
			...
			case 'int':
				...
				// Switch to boolean type if tinyint(1)
				if ($str == 'tinyint(1)') {
					$field = $sql_types['boolean'];
				}
			break;
		}
