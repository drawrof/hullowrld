...
{	
	...
	{												
		...
		// Otherwise, VIEW_DIR/current_controller/ will be the working directory.
			...
			$file = str_replace('_controller','',Router::Instance()->params['controller']).'/'.$file;
		}
	...
	static function Factory($file = null,$data = array(),$partial = false)
	{		
		$view = new View($file,$data,$partial);
		return $view->render();
	}
...
{		
	...
	return View::Factory($file,$data,true);
}
